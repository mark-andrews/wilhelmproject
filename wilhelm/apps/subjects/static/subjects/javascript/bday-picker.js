...
// From http://stackoverflow.com/a/2587398/1009979
...
(function( $ ){
  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker form-group'></fieldset>"),
      ...
      if (settings["defaultDate"]) {
        ...
        var defDate = parseDate(settings['defaultDate'])
